        ...
        <Card className="bg-card border-border shadow-card p-4 sm:p-6">
          ...
          <div>
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between text-xs">
                <span className="text-muted-foreground">Limit: {"<"}8%</span>
        ...
        <div>
          <div className="space-y-2 space-x-2 text-sm">
            ...
            <div className="text-xs text-muted-foreground pt-2 border-t">
              Norma: PN-EN 50160:2010 - Parametry napięcia zasilającego w
              publicznych sieciach elektroenergetycznych
            </div>
          </div>
        </div>
      </Card>
